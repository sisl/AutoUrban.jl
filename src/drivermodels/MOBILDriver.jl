"""
    MOBILDriver
See Treiber & Kesting, 'Modeling Lane-Changing Decisions with MOBILDriver'
"""
...
function observe!(model::MOBILDriver, scene::Union{Scene,Frame{Entity{VehicleState, BicycleModel, Int}}}, roadway::Roadway, egoid::Int)
